...
<head>
    ...
    <!-- DataTables / jQuery UI (same as other admin pages) -->
    ...
    <!-- same CSS block you use on contact-form-data.php -->
    <style>
...
$(function () {
  const table = $('#usersTable').DataTable({
    ...
    ajax: { url: './api/fetch-users.php', dataSrc: 'data' },
    columns: [
  ...
  $('#filter-date').on('click', function () {
    ...
    if (s && e) table.ajax.url(`./api/fetch-users.php?start_date=${s}&end_date=${e}`).load();
  ...
  $(document).on('click', '.delete-btn', function () {
    ...
    $.post('./api/delete-user.php', { id })
      .done(() => table.ajax.reload())
      .fail(() => alert('Error deleting user.'));
  });
});
</script>
